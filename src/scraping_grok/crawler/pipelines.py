...
from scraping_grok.db.store import _redact_dsn, _split_sql, SCHEMA_PATH

log = logging.getLogger("scraping_grok.sql")
clog = logging.getLogger("scraping_grok.crawler")
...
class PostgresPipeline:
    ...
    def process_item(self, item, spider):
        ...
        spider.crawler.stats.inc_value("scraping_grok/pg_upserts")
        return item
